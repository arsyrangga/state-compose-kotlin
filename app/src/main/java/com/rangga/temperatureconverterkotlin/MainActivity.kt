package com.rangga.temperatureconverterkotlin
...
import com.rangga.temperatureconverterkotlin.ui.theme.TemperatureConverterKotlinTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            TemperatureConverterKotlinTheme {
